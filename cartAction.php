...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){ 
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){ 
        ...
        // Get product details 
        $query = $db->query("SELECT * FROM books WHERE id = ".$productID); 
        ...
        if(empty($errorMsg)){ 
            ...
            $insertCust = $db->query("INSERT INTO `customer` (`first_name`, `last_name`, `email, phone`, `address`) VALUES ('".$first_name."', '".$last_name."', '".$email."', '".$phone."', '".$address."')"); 
            ...
            if($insertCust){ 
                ...
                if($insertOrder){ 
                    ...
                    foreach($cartItems as $item){ 
                        $sql .= "INSERT INTO shopping_cart (order_id, product_id, quantity) VALUES ('".$orderID."', '".$item['id']."', '".$item['qty']."');"; 
                    } 
